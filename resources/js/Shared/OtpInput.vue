...
<template>
    <div class="field-wrapper">
        ...
        <div class="flex justify-between space-x-4 form-wrapper">
            <input
                ...
                pattern="[0-9]*"
                type="tel"
                class="block w-full max-w-[3rem] text-center border px-3 py-2 focus:ring-brand-primary focus:border-brand-primary focus:outline-none focus:ring-1 border-brand-secondary/20 bg-brand-light/30 text-brand-dark placeholder-gray-500 disabled:text-brand-dark/20 dark:text-white/80 dark:disabled:text-white/40"
                maxlength="1"
