...
const submit = () =>
    form
        ...
        .post(route(`web.services.pelaporan.store`), {
                ...
                <div class="mt-6">
                    ...
                    >
                        ...
                        <DateInput
                            ...
                            label="Tanggal Kasus Cagar Budaya Yang Dilaporkan"
                        />
                        <FileInput
                    ...
                    <div class="mt-8">
                        ...
                        <div v-if="form.errors?.pelaporan" class="form-error py-4 my-1">
                            {{ form.errors?.pelaporan }}
                        </div>
                    </div>
                </div>
            </div>
