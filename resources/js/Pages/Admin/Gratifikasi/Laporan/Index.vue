                ...
                <div class="flex items-center mt-3">
                    ...
                    <!-- <div class="inline-flex items-center ml-auto">
                        <ButtonSecondary
                            size="md"
                            as="link"
                            :href="route('admin.gratifikasi.laporan.create')"
                            class="text-sm"
                        >
                    ...
                    >
                        <thead>
                            <tr>
                                ...
                                >
                                    Nama Pelapor / NIP / NIK / Whatsapp / Email /
                                    <!-- Golongan /
                                    Satker /
                                    Unit Tugas -->
                                </th>
                                ...
                                <th
                                    ...
                                    class="sticky top-0 z-10 hidden border-b border-gray-100 dark:border-brand-secondary/20 bg-opacity-75 px-3 py-3.5 text-left text-sm font-normal text-brand-secondary dark:text-slate-400 sm:table-cell"
                                >
                                    Tempat Penerimaan / Tanggal Penerimaan
                                </th>
                                <th
                                    scope="col"
                                    class="sticky top-0 z-10 hidden border-b border-gray-100 dark:border-brand-secondary/20 bg-opacity-75 px-3 py-3.5 text-left text-sm font-normal text-brand-secondary dark:text-slate-400 sm:table-cell"
                        ...
                        <tbody>
                            ...
                            <tr v-for="item in laporan.data">
                                ...
                                >
                                    ...
                                    <!-- <div class="text-xs italic text-gray-300">{{ item.pelapor?.golongan }}</div>
                                    <div class="text-xs italic text-gray-300">{{ item.pelapor?.satker }}</div>
                                    <div class="text-xs italic text-gray-300">{{ item.pelapor?.unit_tugas }}</div> -->
                                    <div
                                ...
                                >
                                    <div class="flex">{{ item.pemberi?.nama }}</div>
                                    <div class="text-xs italic text-gray-300">
                                        {{ item.pemberi?.whatsapp }}
                                    </div>
                                    <div class="text-xs italic text-gray-300">
                                        {{ item.pemberi?.email }}
                                    </div>
                                    <!-- <div class="text-xs italic text-gray-300">{{ item.pemberi?.pekerjaan }}</div>
                                    <div class="text-xs italic text-gray-300">{{ item.pemberi?.jabatan }}</div>
                                    <div class="text-xs italic text-gray-300">{{ item.pemberi?.hubungan }}</div>
                                    <div class="text-xs italic text-gray-300">{{ item.pemberi?.alamat }}</div> -->
                                </td>
                                <td
                                    :class="[
                                        'hidden px-3 py-2 text-sm border-b border-gray-100 dark:border-brand-secondary/20 whitespace-normal sm:table-cell',
                                ...
                                >
                                    <div class="flex">{{ item.tempat }}</div>
                                    <div class="text-xs italic text-gray-300">
                                        {{ item.tanggal?.short }}
                                    </div>
                                </td>
                                    ...
                                    >
                                        <template #prepend-menu>
                                            <MenuItem>
                                                <Link
                                                    :href="
                                                        route('admin.gratifikasi.laporan.show', {
                                                            laporan: item.id,
                                                        })
                                                    "
...
const deletelaporan = () =>
    deletelaporanForm.delete(
        route('admin.gratifikasi.laporan.destroy', {
