<template>
    <div class="flex">
        <label
            class="relative flex items-center text-brand-secondary/60 focus-within:text-brand-secondary dark:text-slate-600 dark:focus-within:text-brand-primary"
        >
...
const submit = (query) =>
    Inertia.get(route('kedeka::admin.survey.question.index'), query, { preserveState: true });
</script>
